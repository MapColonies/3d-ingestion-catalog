...
import { Column, Entity, UpdateDateColumn, CreateDateColumn, Unique} from 'typeorm';
...
export class Metadata {
  ...
  @Unique('product_name_unique', ['productName'])
  ...
  public productType: ProductType = ProductType.PHOTO_REALISTIC;
  @Column({ name: 'product_sub_type', type: 'text', nullable: true })
